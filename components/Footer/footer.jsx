...
function Footer() {
  return (
    <>
          ...
          <div className="flex gap-2 justify-between max-md:flex-col max-md:text-center">
            <div>
              <h4 className="text-3xl pb-4 font-bold font-title">
                Developer
                <span className="text-blue-400">Week</span>
              </h4>
              <p className="text-gray-500 pb-2">Join others and never miss out on our Latest Updates.</p>
              ...
              <div className="mb-5 md:mx-40">
                ...
                <ul className="text-gray-500">
                  <li className="pb-2 flex">
                    ...
                    <span className="hover:text-blue-400 cursor-pointer font-semibold duration-200">About Us</span>
                  </li>
                  <li className="pb-2 flex">
                    <BiChevronRight className="relative text-blue-400" size={25} />
                    <a href="https://tailwindcss.com/" target="_blank" rel="noreferrer" className="hover:text-blue-400 cursor-pointer font-semibold duration-200">Blogs</a>
                  </li>
                  <li className="pb-2 flex">
                    <BiChevronRight className="relative text-blue-400" size={25} />
                    <a href="https://nextjs.org/" target="_blank" rel="noreferrer" className="hover:text-blue-400 cursor-pointer font-semibold duration-200">Communities</a>
                  </li>
                </ul>
              </div>
              <div className="mb-5">
      ...
      <div className="bg-gray-600 text-gray-400 flex max-sm:flex-col justify-between items-center px-10 py-2 font-semibold text-center">
        <div className="text-base">©2023 Developer Week Team™. All Rights Reserved.</div>
