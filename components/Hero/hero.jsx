...
const Hero = () => {
  return (
    <>
      <div name="about" className=" h-screen max-md:h-full w-full pb-72 bg-gradient-to-br ">
        <div className="max-w-screen-lg  mx-auto flex flex-col-reverse items-center justify-between h-full md:flex-row">
          <div className = " mb-32 pr-12 flex flex-col max-md:items-center justify-center ">
          ...
          <div className = "pl-12 ml-13 flex flex-col items-center justify-center md:hover:scale-125 duration-300">
